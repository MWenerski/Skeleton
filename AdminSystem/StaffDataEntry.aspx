...
<body style="height: 549px">
    <form id="form1" runat="server">
        <div style="height: 586px">
            ...
            <asp:Label ID="lblDateJoined" runat="server" style="z-index: 1; left: 20px; top: 262px; position: absolute" Text="Date Joined" width="72px"></asp:Label>
            ...
            <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 100px; top: 497px; position: absolute" Text="Cancel" />
            <asp:Button ID="btnFind" runat="server" OnClick="btnFind_Click" style="z-index: 1; left: 311px; top: 20px; position: absolute" Text="Find" />
            <asp:TextBox ID="txtStaffId" runat="server" style="z-index: 1; left: 145px; top: 25px; position: absolute">Enter text here</asp:TextBox>
            <asp:Label ID="lblSttaffId" runat="server" style="z-index: 1; left: 17px; top: 29px; position: absolute" Text="Staff Id"></asp:Label>
        </div>
        ...
        <asp:Calendar ID="cldrDateJoined" runat="server" style="z-index: 1; left: 150px; top: 261px; position: absolute; height: 188px; width: 259px"></asp:Calendar>
        <p>
            &nbsp;</p>
    </form>
</body>
