...
&nbsp;<asp:TextBox ID="txtGameID" runat="server" height="22px" style="z-index: 1; top: 16px; position: absolute; width: 128px; left: 125px; bottom: 633px;"></asp:TextBox>
        </div>
        ...
        <p>
            ...
            <asp:TextBox ID="txtGamePrice" runat="server" height="22px" style="z-index: 1; left: 125px; top: 93px; position: absolute" width="128px"></asp:TextBox>
        </p>
        <p>
            ...
            <asp:TextBox ID="txtAmountInStock" runat="server" height="22px" style="z-index: 1; left: 125px; top: 130px; position: absolute" width="128px"></asp:TextBox>
        </p>
        <p>
        ...
        <p>
            ...
            <asp:TextBox ID="txtReleaseDate" runat="server" height="22px" style="z-index: 1; left: 125px; top: 208px; position: absolute" width="128px"></asp:TextBox>
        </p>
        <p>
