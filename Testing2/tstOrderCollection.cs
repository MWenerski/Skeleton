...
namespace Test_Framework
{
    ...
    public class tstOrderCollection
    {
        ...
        public void AddMethodOK()
        {
            ...
            //THE FOLLOWING CODE REMOVES THIS AUTOGENERATED ENTRY FROM THE TABLE.
            //You can comment it out and refresh tblOrder if you would like to verify that the data was added.
            AllOrders.ThisOrder.Find(PrimaryKey);
            AllOrders.Delete();
        }
        ...
        public void UpdateMethodOK()
        {
            ...
            TestItem.GameName = "Auto-updated via test";
            TestItem.OrderDate = DateTime.Today.Date;
            ...
            //THE FOLLOWING CODE REMOVES THIS AUTOGENERATED ENTRY FROM THE TABLE.
            //You can comment it out and refresh tblOrder if you would like to verify that the data was updated.
            AllOrders.ThisOrder.Find(PrimaryKey);
            AllOrders.Delete();
        }
        ...
        public void ReportByGameNameDataFound()
        {
            clsOrderCollection FilteredOrders = new clsOrderCollection();
            Boolean OK = true;
            FilteredOrders.ReportByGameName("Undertale");
            if(FilteredOrders.Count == 1)
            {
                if (FilteredOrders.OrderList[0].OrderID != 289598)
                {
                    OK = false;
                }
            } else
